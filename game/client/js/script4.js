...
function setup() {
    ...
    socket = io();
        ...
        socket.on('GG',function(){
            if(array[mynumber].team == 0){
                button3 = createButton('You lose! LMAO');
                button3.position(windowWidth/2,windowHeight/2);
                button3.size(200,100);
               button3.mousePressed(function(){
                    socket.emit('ReadytoRestart', mynumber);
                    button3.remove();
                })
            }
            else if (array[mynumber].team == 1){
                button3 = createButton('You win! PogChamp');
                button3.position(windowWidth/2,windowHeight/2);
                button3.size(200,100);
                button3.mousePressed(function(){
                    socket.emit('ReadytoRestart', mynumber);
        ...
        socket.on('hiderGG', function(){
            if(array[mynumber].team == 0){
                button3 = createButton('You win! PogChamp' + array[mynumber].team);
                console.log('123131231231232131');
                button3.position(windowWidth/2,windowHeight/2);
                button3.size(200,100);
                button3.mousePressed(function(){
                    socket.emit('ReadytoRestart', mynumber);
                ...
                button3 = createButton('You lose! LMAO' + array[mynumber].team);
                console.log('123131231231232131');
                button3.position(windowWidth/2,windowHeight/2);
                button3.size(200,100);
                button3.mousePressed(function(){
