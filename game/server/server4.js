...
function initializegame(){
   ...
   // end = 0;
    ...
    for(var i in array){
        ...
        io.emit('GameStartUpdate', {x: array[i].x, y: array[i].y});
    }
...
socket.on('pickitem', function(data){
    ...
    arrayofitem.splice(arrayofitem[data.pickeditem], 1);
})
...
socket.on('ReadytoRestart', function(data){
    array[data].ReadyToRestart = 1;
})
socket.on('GameReady', function(data){
    ...
    console.log(array[data.number].Ready);
})
})
