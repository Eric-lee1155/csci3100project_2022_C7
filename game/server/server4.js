...
// Connect to database
const dbURi = 'mongodb+srv://stu150:p351885-@csci2720.m2qbq.mongodb.net/stu150';
...
// Schema Definition
const ClientINFO = schema({
    ipadress: { type: String, required: true },
    flaglogin: { type: String, required: true },
});


// this part is for client
let condition = {ipadress: 'varXXXXXXipadress', flaglogin: 'true'};
